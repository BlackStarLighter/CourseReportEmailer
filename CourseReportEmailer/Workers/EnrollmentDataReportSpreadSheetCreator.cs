...
{
    internal class EnrollmentDataReportSpreadSheetCreator
    {
        public void Create(string fileName, IList<EnrollmentDetailReportModel> enrollmentModels)
        {
            using (SpreadsheetDocument document = SpreadsheetDocument.Create(fileName, SpreadsheetDocumentType.Workbook))
            {
                ...
                DataTable enrollmentTable = (DataTable)JsonConvert.DeserializeObject(json, typeof(DataTable));
                ...
                foreach(DataColumn tableColumn in enrollmentTable.Columns)
                {
                    Cell cell = new Cell();
                ...
                foreach(DataRow tableRow in enrollmentTable.Rows)
                {
